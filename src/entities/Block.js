...
export default class Block extends Rectangle {
	...
	static BLOCK_SPRITE_MEASUREMENTS = {
	...
	constructor(x, y, size, angle = Block.ANGLE_VERTICAL) {
		super(
			x,
			y,
			Block.BLOCK_SPRITE_MEASUREMENTS[size].width,
			Block.BLOCK_SPRITE_MEASUREMENTS[size].height,
			{
				angle: angle,
		...
		this.blockSprites = Block.generateSprites();
	...
	static generateSprites() {
		return [
			new Sprite(
				...
				Block.BLOCK_SPRITE_MEASUREMENTS[Size.Small].x,
				Block.BLOCK_SPRITE_MEASUREMENTS[Size.Small].y,
				Block.BLOCK_SPRITE_MEASUREMENTS[Size.Small].width,
				Block.BLOCK_SPRITE_MEASUREMENTS[Size.Small].height
			),
			new Sprite(
				images.get(ImageName.Wood),
				Block.BLOCK_SPRITE_MEASUREMENTS[Size.Medium].x,
				Block.BLOCK_SPRITE_MEASUREMENTS[Size.Medium].y,
				Block.BLOCK_SPRITE_MEASUREMENTS[Size.Medium].width,
				Block.BLOCK_SPRITE_MEASUREMENTS[Size.Medium].height
			),
			new Sprite(
				images.get(ImageName.Wood),
				Block.BLOCK_SPRITE_MEASUREMENTS[Size.Large].x,
				Block.BLOCK_SPRITE_MEASUREMENTS[Size.Large].y,
				Block.BLOCK_SPRITE_MEASUREMENTS[Size.Large].width,
				Block.BLOCK_SPRITE_MEASUREMENTS[Size.Large].height
			),
		];
	};
